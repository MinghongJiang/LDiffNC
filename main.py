...
parser.add_argument('--config', default="./config/cifar100/cifar100_LSC_Mixup.txt", help='path to config file')
...
parser.add_argument('--diffusion_epoch', default=201, type=int, help='diffusion epoch to train') #default=201
parser.add_argument('--model_fixed', default=None, type=str, help='the encoder model path')
parser.add_argument('--feature_ratio', default=0.2, type=float, help='The ratio of generating feature') #default=0.20
parser.add_argument('--diffusion_step', default=1000, type=int, help='The steps of diffusion') #default=1000
...
parser.add_argument('--generation_mmf', default="new", type=str, help='CNN fully connected layer batch size') # all/few/new means balance generate policy
